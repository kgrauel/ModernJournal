...
SECRETS = interface.get_secrets("../backend/secrets_test.json");

def setup_module(module):
    """ setup any state specific to the execution of the given module."""
    # invoke node ../backend/clear_db -s secrets_test.json -f
    print("Clearing database...")
    os.system("node ../backend/clear_db -s ../backend/secrets_test.json -f")
    



# TODO: invoke server with secrets_test.json
